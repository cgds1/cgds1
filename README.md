# Hi, I'm Carlos Díaz
### Fullstack Developer · Computer Engineering

---

## About Me

Fullstack developer building production-grade web and mobile applications across the full stack. I work with NestJS and PostgreSQL on the backend, Flutter with Riverpod on mobile, and React/Next.js on the frontend. I also build AI-powered conversational agents, serverless platforms on GCP and workflow automations integrated with ERP systems.

- 🎓 Computer Engineering · Universidad Rafael Urdaneta, Maracaibo
- ☁️ Serverless architectures on Google Cloud Platform (Cloud Run, Cloud Build, Secret Manager)
- 🤖 AI agents & automation with n8n, Claude API and WhatsApp Cloud API
- 🔗 ERP integration with Odoo via XML-RPC and Google Workspace API (Drive, Sheets, OAuth 2.0)
- 🔐 Auth systems with JWT rotation, token family tracking, bcrypt and RBAC
- 🐳 Docker, CI/CD with GitHub Actions / Cloud Build, and production deployments
